...
#define JL_LA_DEFAULT_SAMPLES         10000       // Default sample count
#define JL_LA_MAX_SAMPLES_LIMIT       262144      // 256K maximum samples
...
// Enhanced Jumperless Protocol Commands
#define JL_CMD_RESET                0x00    // Reset device
#define JL_CMD_RUN                  0x01    // Start capture
#define JL_CMD_ID                   0x02    // Get device ID
#define JL_CMD_GET_HEADER           0x03    // Get capabilities header
#define JL_CMD_SET_CHANNELS         0x04    // Configure channels (8 bytes)
#define JL_CMD_ARM                  0x05    // Arm trigger
#define JL_CMD_GET_STATUS           0x06    // Get status
#define JL_CMD_CONFIGURE            0x07    // Set sample rate/count (8 bytes)
#define JL_CMD_SET_SAMPLES          0x08    // Set sample count only (4 bytes)
