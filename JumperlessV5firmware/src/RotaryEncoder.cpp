...
void rotaryEncoderStuff(void)
{
    ...
    // Serial.print(lastPositionEncoder);
    // Serial.println("\n\r");
     encoderBstate = digitalRead(QUADRATURE_B_PIN);
     lastEncoderBstate = encoderBstate;

    if (encoderBstate != lastEncoderBstate)
    {
        Serial.print("encoderBstate: ");
        Serial.print(encoderBstate);
        Serial.print("\t");
        Serial.print("lastEncoderBstate: ");
        Serial.print(lastEncoderBstate);
        Serial.println("\n\r");
    }
     
    //Serial.println(digitalRead(QUADRATURE_B_PIN));
    ...
    if (abs(lastPositionEncoder - encoderRaw) >= 2) // justPressed*2)
    {
        // Serial.print("abs(lastPositionEncoder - encoderRaw): ");
        // Serial.println(abs(abs(lastPositionEncoder) - abs(encoderRaw)), HEX);
        // // justPressed = 1;
        // Serial.print("!!!!!!!!!encoderRaw: ");
        // Serial.print(encoderRaw);
        // Serial.print("\t");
